class LocalStorageService {
    ...
    set sortCol(col) { this.model.options.sortCol = col; }
    get sortDir() { return this.model.options.sortDir; }
    set sortDir(dir) { this.model.options.sortDir = dir; }
    set filterStr(filterStr) { this.model.options.filterStr = filterStr; }
